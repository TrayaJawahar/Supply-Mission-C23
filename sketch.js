...
function setup() {
	...
	wall2Sprite=createSprite((width/2)-100,610,20,100);
	wall2Sprite.shapeColor="red";
	

	wall3Sprite=createSprite((width/2)+100,610,20,100);
	...
	//Create a Ground
	 ...
	 wall2 = Bodies.rectangle((width/2)-100, 610, 20, 100 , {isStatic:true} );
	 World.add(world,wall2);
	 
	 wall3 = Bodies.rectangle((width/2)+100, 610, 20, 100 , {isStatic:true} );
	 World.add(world, ground);
